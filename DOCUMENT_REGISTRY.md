# Deep Study Document Registry

این registry از تداخل Document ID جلوگیری می‌کند و مشخص می‌کند هر سند canonical کجاست.

| Document ID | Curriculum ID | Track | Title | Version | Status | Canonical source | PDF artifact |
|---|---|---|---|---|---|---|---|
...
- قبل از انتشار هر Study PDF، Document ID آن باید اینجا ثبت شود.
- `published-canonical` فقط وضعیت سند است و به معنی تسلط learner نیست.
- وضعیت learner در progress مسیر جدا ثبت می‌شود.
